...
<body>
	...
	if (userReq.contains("/")) {
		...
		userReq2 = userReq2.substring(userReq2.indexOf("/admins") + 8);
	...
	if (request.getParameter("search") == null) {
		count = users.countUsers("admin");
	}

	if (request.getParameter("search") != null) {
		count = users.countSearchUsers(request.getParameter("search"), "admin");
	}
	//------------------------------------------------------------
	...
	<div style="margin-top: 50px;">
		<div class="row">
			...
			<div class="col-md-10" style="padding: 20px;" id="main">
				...
				<%-- Search --%>
				<form action="<%=um.baseUrl(request, "/backend/admins/1/")%>"
					class="form-row">
					<div class="form-group col">

						<input class="form-control shadow" id="body"
				...
				<div class="text-left img-thumbnail">
					<h4>
						Site Admins &emsp; <span class="h6">Total (<%=(int) count%>)
						</span>
					</h4>
				</div>
									...
									<table
										...
										<tbody>
											...
											if (request.getParameter("search") == null) {
												...
												//get data from db
												List<Users> list = users.getAllUsers("admin", start, (int) total);
												...
												//list users in table
												for (Users us : list) {
													out.println("<tr>" + "<td>&nbsp; &nbsp; " + No++ + "</td>" + "<td>&nbsp; &nbsp; " + us.getId() + "</td>"
													+ "<td>&nbsp; &nbsp; " + us.getFirstname() + "</td>" + "<td>&nbsp; &nbsp; " + us.getLastname() + "</td>"
													+ "<td>&nbsp; &nbsp; " + us.getUsername() + "</td>" + "<td>&nbsp; &nbsp; " + us.getEmail() + "</td>"
													+ "<td>&nbsp; &nbsp; "
													+ us.getJoined().substring(us.getJoined().indexOf(" "), us.getJoined().indexOf(" T")) + "</td>"
													+ "<td>&nbsp; &nbsp; " + us.getTag() + "</td>" + "<td>&nbsp; &nbsp; <a href='" + webAddress
											...
											if (request.getParameter("search") != null) {
												...
												//get data from db
												List<Users> list = users.searchUsers(request.getParameter("search"), "admin", start, (int) total);
